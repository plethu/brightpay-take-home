    ...
    OfferConfiguration Configuration)
{
        ...
        where TConfiguration : OfferConfiguration
    {
        ...
        {
            typed = new OfferDefinition<TConfiguration>(Code, Sku, Type, State, (TConfiguration)Configuration);
            return true;
        }
    ...
    where TConfiguration : OfferConfiguration
{
    ...
    public OfferDefinition ToUntyped() => new(Code, Sku, Type, State, Configuration);
}
